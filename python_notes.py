...
# Let's say you were receiving data from an external source like a data base, and wanted to turn this dictionary data 
# into a Player object so you could write some useful methods associated with players. You can imagine just from the 
# way the dictionary is structured that you might write your class like this:
...
# Now you have a Player object, that you can write methods for! You can also make more player instances if you have 
# more data that comes back in that format.

# *Other Fun Facts About Dictionaries

# *They're Fast
# You are already familiar with Python dictionaries, but almost every language has a built-in key-value pair data 
# structure. They are widely used, extremely powerful and considered fundamental for one primary reason:

# They provide constant-time lookup, insertion and deletion on average
# Many extremely common problems are best solved with the key-value pair data structure (commonly called a hash 
# table in computer science.) Some examples: Dealing with uniqueness of data, frequency of values, and finding 
...
# We often use Object Oriented Programming for web development because we want to work more efficiently and write less code. In order to achieve better code, we use the 4 pillars of OOP.
...
# *1. Encapsulation
# Encapsulation is the idea that we can group code together into objects; hence Object Oriented Programming. We use 
# classes or "coding blue prints" to define what our objects are and how they behave. We encapsulate attributes and 
...
# *2. Inheritance
# Inheritance is the idea that we pass along attributes and methods from one class into a "sub-class" or child class, 
# and not have to re-write the code to make it work. Child classes can be more specific versions of their Parent class. 
...
# *3. Polymorphism
# Polymorphism means "many forms", and the idea in OOP is that a Child class can have a different version of a method 
# than the Parent class. In this example the child class of CappuccinoM has a clean method, and so does CoffeeM. 
...
# *4. Abstraction
# Abstraction is an extension of Encapsulation, and we can hide attributes or methods that a Barista doesn't need to 
# know about, like a CoffeeM. That way the Barista can make a cup of coffee in a simpler manner.
